...
public class Subscription extends TableImpl<SubscriptionRecord> {
    ...
    /**
     * The column <code>SUBSCRIPTION.CHATID</code>.
     */
    public final TableField<SubscriptionRecord, Long> CHATID = createField(DSL.name("CHATID"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>SUBSCRIPTION.LINKID</code>.
     */
    public final TableField<SubscriptionRecord, Long> LINKID = createField(DSL.name("LINKID"), SQLDataType.BIGINT, this, "");
    ...
    public Chat chat() {
        if (_chat == null)
            _chat = new Chat(this, Keys.CONSTRAINT_9E);
