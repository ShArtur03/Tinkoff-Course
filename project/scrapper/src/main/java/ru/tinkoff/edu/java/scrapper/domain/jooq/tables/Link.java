...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    /**
     * The column <code>LINK.LASTCHECKTIME</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LASTCHECKTIME = createField(DSL.name("LASTCHECKTIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field("LOCALTIMESTAMP", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>LINK.LASTUPDATETIME</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LASTUPDATETIME = createField(DSL.name("LASTUPDATETIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field("LOCALTIMESTAMP", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
