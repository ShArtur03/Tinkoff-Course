...
public class Keys {
    ...
    public static final ForeignKey<SubscriptionRecord, ChatRecord> CONSTRAINT_9E = Internal.createForeignKey(Subscription.SUBSCRIPTION, DSL.name("CONSTRAINT_9E"), new TableField[] { Subscription.SUBSCRIPTION.CHATID }, Keys.CONSTRAINT_1, new TableField[] { Chat.CHAT.ID }, true);
    public static final ForeignKey<SubscriptionRecord, LinkRecord> CONSTRAINT_9E7 = Internal.createForeignKey(Subscription.SUBSCRIPTION, DSL.name("CONSTRAINT_9E7"), new TableField[] { Subscription.SUBSCRIPTION.LINKID }, Keys.CONSTRAINT_2, new TableField[] { Link.LINK.ID }, true);
}
